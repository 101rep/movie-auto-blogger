...
Plans exactly 3 distinct daily slots with non-overlapping search intents and entity isolation.
Slots:
  Slot 1: 09:00 KST - Movie TOP 5 (movie-top5-writer)
  Slot 2: 14:00 KST - Single Title Deep Dive (ott-movie-review)
  Slot 3: 20:00 KST - OTT Theme Curator (ott-theme-curator)
"""
...
class DailyContentPlanner:
    """Plans daily content generation for EnterPick24 (3 slots/day)."""
    ...
    def create_daily_plan(self, target_date: Optional[str] = None) -> List[Dict[str, Any]]:
        """
        Creates a structured daily plan of 3 slots.
    ...
    def format_plan_report(self, plans: List[Dict[str, Any]]) -> str:
        ...
        lines = [
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━",
            "총 3개 슬롯 (검색 의도 및 엔티티 중복 격리 검증 완료)\n"
        ]
        for p in plans:
